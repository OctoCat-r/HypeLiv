...
function Works({ item, key }: Props) {
  ...
  return (
    <div className="flex justify-center items-center">
      <div>
        <motion.div
          className="rounded-full w-12 h-16 bg-purple-400 ml-2 flex items-center justify-center"
          ref={ref}
          style={{
            scale,
          }}
      ...
      <motion.div
        className="mb-10 mt-16 w-1/2 md:px-12 text-black px-4"
        ref={ref}
        style={{
      ...
      >
        ...
        <p className="text-xl font-semibold mb-3 font-serif">{item.title}</p>
